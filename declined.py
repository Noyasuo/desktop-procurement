...
class DeclinedScreen(tk.Frame):
    ...
    def create_widgets(self):
        # Title label
        tk.Label(self, text="Declined Requests", font=("Arial", 16), bg="lightgrey").pack(pady=20)
...
# To test the DeclinedScreen independently, you can create a root window and add it to this script.
if __name__ == "__main__":
    root = tk.Tk()
    root.geometry("800x500")
    app = DeclinedScreen(master=root)
